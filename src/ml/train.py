...
def main(cfg: Config | None = None) -> None:
    ...
    # reload best, calibrate thresholds on val, evaluate test, persist artifacts
    ...
    save_artifacts(Path(cfg.artifacts_dir), model, cfg, data, val_metrics, test_metrics, thresholds, run_id)
    print(f"[done] best epoch={best_epoch} val_mean_PR_AUC={best_pr:.4f}; artifacts → {cfg.artifacts_dir}")
